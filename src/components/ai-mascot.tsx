...
export function AIMascot() {
  ...
  return (
    <>
      {/* Chat popup */}
      {open && (
        <div className="fixed bottom-24 right-6 z-[90] w-[360px] max-h-[500px] rounded-2xl border border-border bg-card shadow-2xl shadow-black/30 flex flex-col animate-scale-in overflow-hidden">
          {/* Header */}
