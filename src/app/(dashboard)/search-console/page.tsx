        ...
        <div className="rounded-2xl border border-border bg-muted/40 p-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <input
              ...
              className="flex-1 rounded-xl border border-border bg-muted/60 px-4 py-3 text-sm text-foreground placeholder-muted-foreground/50 outline-none focus:border-teal-500/50"
            />
            <button
              onClick={fetchGSC}
              disabled={loading || !url.trim()}
              className="flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-teal-600 to-cyan-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-teal-500/20 hover:brightness-110 disabled:opacity-50 whitespace-nowrap"
            >
        ...
        {data && (
          <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
                { label: "Total Clicks", value: data.summary.totalClicks.toLocaleString(), icon: MousePointerClick, color: "#14b8a6" },
